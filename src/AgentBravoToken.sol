...
/// @title AgentBravoToken
/// @notice A token for the AgentBravo project
/// @custom:security-contact mike@mikeghen.com
contract AgentBravoToken is
    Initializable,
    ERC20Upgradeable,
    ...
    UUPSUpgradeable
{
    ...
    function initialize(address defaultAdmin, address pauser, address minter, address upgrader) public initializer {
        __ERC20_init("Agent Bravo Token", "BRAVO");
        __ERC20Burnable_init();
        __ERC20Pausable_init();
        __AccessControl_init();
        __ERC20Permit_init("Agent Bravo Token");
        __ERC20Votes_init();
